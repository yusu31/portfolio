...
export const BASKETBALL_WAYPOINTS: Waypoint[] = [
  ...
  // キャッチ（hotspot 0: frontend）─ 非対称構図: カメラ左上 → ボール右下
  { progress: 0.16, pos: [  0, -0.2,  0], camOffset: [-4.5,  2.8, 5.0], rotSpeed: 0.2, hotspotIndex: 0 },

  // ── Phase 2: シュート → リム [0, 2.6, -8.77] ────────────────────────────
  // rotSpeed 負値 = バックスピン
  { progress: 0.22, pos: [  0, -0.5,  0], camOffset: [-2.5,  1.5, 5.0], rotSpeed: -0.5 },
  { progress: 0.28, pos: [  0,  0.5,  0], camOffset: [-2.0,  1.2, 5.5], rotSpeed: -3.5, impact: true },
  { progress: 0.35, pos: [1.5,  3.5, -3], camOffset: [-2.0,  0.0, 6.0], rotSpeed: -4.0 },
  { progress: 0.42, pos: [2.0,  6.0, -5], camOffset: [-1.5, -0.5, 6.5], rotSpeed: -3.5 },
  // 頂点（hotspot 1: backend）─ カメラ左 → ボール右 → 左の暗闇にカード
  { progress: 0.47, pos: [2.5,  7.0, -6], camOffset: [-3.5,  0.8, 6.5], rotSpeed: -2.5, hotspotIndex: 1 },
  ...
  // リム手前（hotspot 2: infrastructure）─ カメラ左 → リング右下
  { progress: 0.68, pos: [0.0,  3.0,-8.5], camOffset: [-2.5,  1.8, 4.5], rotSpeed: -4.0, hotspotIndex: 2 },
